...
<div class="admin-shell">
  ...
  <aside class="sidebar" data-sidebar>
    ...
    <nav class="sidebar__nav" data-sidebar-nav>
      <button type="button" class="sidebar__link" data-section-btn="hero" data-i18n-title="admin.nav.hero" data-i18n-aria="admin.nav.hero" title="Inicio" aria-label="Inicio"><span class="sidebar__link-icon"><?= icon('home') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.hero">Inicio</span></button>
      <button type="button" class="sidebar__link" data-section-btn="projects" data-i18n-title="admin.nav.projects" data-i18n-aria="admin.nav.projects" title="Proyectos" aria-label="Proyectos"><span class="sidebar__link-icon"><?= icon('folder') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.projects">Proyectos</span></button>
      <button type="button" class="sidebar__link" data-section-btn="skills" data-i18n-title="admin.nav.skills" data-i18n-aria="admin.nav.skills" title="Habilidades" aria-label="Habilidades"><span class="sidebar__link-icon"><?= icon('brain') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.skills">Habilidades</span></button>
      <button type="button" class="sidebar__link" data-section-btn="experience" data-i18n-title="admin.nav.experience" data-i18n-aria="admin.nav.experience" title="Experiencia" aria-label="Experiencia"><span class="sidebar__link-icon"><?= icon('briefcase') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.experience">Experiencia</span></button>
      <button type="button" class="sidebar__link" data-section-btn="education" data-i18n-title="admin.nav.education" data-i18n-aria="admin.nav.education" title="Educación" aria-label="Educación"><span class="sidebar__link-icon"><?= icon('graduation-cap') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.education">Educación</span></button>
      <button type="button" class="sidebar__link" data-section-btn="contact" data-i18n-title="admin.nav.contact" data-i18n-aria="admin.nav.contact" title="Contacto" aria-label="Contacto"><span class="sidebar__link-icon"><?= icon('mail') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.contact">Contacto</span></button>
      <button type="button" class="sidebar__link" data-section-btn="cv" data-i18n-title="admin.nav.cv" data-i18n-aria="admin.nav.cv" title="CV" aria-label="CV"><span class="sidebar__link-icon"><?= icon('file-text') ?></span><span class="sidebar__link-label" data-i18n="admin.nav.cv">CV</span></button>
    </nav>
    <div class="sidebar__footer">
      ...
      <a href="logout.php" class="is-danger" data-i18n-title="admin.sidebar.logout" data-i18n-aria="admin.sidebar.logout" title="Cerrar sesión" aria-label="Cerrar sesión"><?= icon('log-out') ?><span class="sidebar__link-label" data-i18n="admin.sidebar.logout">Cerrar sesión</span></a>
    </div>
  </aside>
  ...
  <main class="admin-main">
    <div class="topbar">
      <div class="topbar__title-group">
        ...
        <div>
          <p class="topbar__title" data-section-title>Inicio</p>
    ...
    <div class="admin-body">
      <div class="form-column">
        ...
        <!-- INICIO / HERO -->
        <section class="panel" data-section-panel="hero">
          <div class="card">
            <p class="card__title" data-i18n="admin.hero.cardTitle">Encabezado (hero)</p>
          ...
          <div class="card">
            <p class="card__title" data-i18n="admin.hero.facts.cardTitle">Ficha rápida</p>
          ...
          <div class="card">
            <p class="card__title" data-i18n="admin.hero.social.cardTitle">Redes sociales</p>
            ...
            <div class="chip-input" data-social-links>
              ...
              <input type="text" class="chip-input__text" data-social-text placeholder="https://linkedin.com/in/tu-usuario o tu@correo.com" inputmode="url" autocomplete="off">
            </div>
          </div>
        </section>

        <!-- PROYECTOS -->
        <section class="panel" data-section-panel="projects" hidden>
        ...
        <!-- HABILIDADES -->
        <section class="panel" data-section-panel="skills" hidden>
        ...
        <!-- EXPERIENCIA -->
        <section class="panel" data-section-panel="experience" hidden>
        ...
        <!-- EDUCACIÓN -->
        <section class="panel" data-section-panel="education" hidden>
          ...
          <div class="card">
            <p class="card__title"><span data-i18n="admin.education.langs.cardTitle">Idiomas</span> <span class="translatable-badge" data-i18n="admin.translatable">traducible</span></p>
          ...
          <div class="card">
            <p class="card__title" data-i18n="admin.education.certs.cardTitle">Certificaciones</p>
        ...
        <!-- CONTACTO -->
        <section class="panel" data-section-panel="contact" hidden>
          <div class="card">
            <p class="card__title" data-i18n="admin.contact.cardTitle">Medios de contacto</p>
        ...
        <!-- CV -->
        <section class="panel" data-section-panel="cv" hidden>
          <div class="card">
...
<script src="<?= asset_url('assets/js/admin-icons.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-i18n.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-state.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-sections.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-preview.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-preview-highlight.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-preview-resize.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-sortable.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-chip-input.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-social-links.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-datepicker.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-confirm-dialog.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-forms.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-upload.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-save.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-draft.js') ?>"></script>
<script src="<?= asset_url('assets/js/admin-responsive.js') ?>"></script>
</body>
</html>
